...
const COURSE_PRESETS = [
  ...
  { id: 'preset_st_margarets',     name: "St Margaret's Golf & Country Club", location: 'Finglas, Dublin', country: 'IE', par: 73, yardage: 6623, holes: 18,
    holeTemplate: [
      { hole_num: 1,  par: 4, yardage: 348, stroke_index: 13 },
      { hole_num: 2,  par: 3, yardage: 145, stroke_index: 17 },
      { hole_num: 3,  par: 5, yardage: 509, stroke_index: 1  },
      { hole_num: 4,  par: 4, yardage: 438, stroke_index: 11 },
      { hole_num: 5,  par: 3, yardage: 174, stroke_index: 15 },
      { hole_num: 6,  par: 4, yardage: 417, stroke_index: 3  },
      { hole_num: 7,  par: 4, yardage: 362, stroke_index: 5  },
      { hole_num: 8,  par: 4, yardage: 495, stroke_index: 9  },
      { hole_num: 9,  par: 4, yardage: 384, stroke_index: 7  },
      { hole_num: 10, par: 4, yardage: 354, stroke_index: 10 },
      { hole_num: 11, par: 4, yardage: 464, stroke_index: 6  },
      { hole_num: 12, par: 4, yardage: 170, stroke_index: 18 },
      { hole_num: 13, par: 4, yardage: 393, stroke_index: 12 },
      { hole_num: 14, par: 3, yardage: 155, stroke_index: 14 },
      { hole_num: 15, par: 5, yardage: 502, stroke_index: 16 },
      { hole_num: 16, par: 4, yardage: 443, stroke_index: 2  },
      { hole_num: 17, par: 5, yardage: 366, stroke_index: 8  },
      { hole_num: 18, par: 4, yardage: 458, stroke_index: 4  },
    ],
  },
...
// HOME
// ==============================
function HomeScreen({ db, onStart, onResume, onOpen, onStats, onCaddy, onBag, onSettings, onAbandon }){
        ...
        <div className="px-5 pt-5">
          <div className="card" style={{padding:18, borderColor:'var(--ink)', background:'var(--surface)'}}>
            ...
            <div style={{display:'flex', gap:8}}>
              <button className="btn btn-primary" onClick={onResume} style={{flex:1}}>
                Continue round <ArrowRight size={16}/>
              </button>
              <button
                onClick={() => { if (confirm('Discard this round? This cannot be undone.')) onAbandon(); }}
                style={{
                  flexShrink:0, padding:'14px 16px', borderRadius:12,
                  background:'transparent', border:'1px solid var(--neg)',
                  color:'var(--neg)', cursor:'pointer', fontSize:13, fontWeight:600,
      ...
      {allAvailablePresets.length > 0 && (
        <Section title={`Course library · ${allAvailablePresets.length} courses`} action={
          <button onClick={() => setShowLibrary(!showLibrary)} style={{
            ...
            background: showLibrary ? 'var(--ink)' : 'var(--accent)',
            color:'var(--surface)', border:'none', fontFamily:'DM Sans, sans-serif'
          }}>
